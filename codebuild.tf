...
#################### CODEBUILD TEST #############################
resource "aws_codebuild_project" "t223306781sit722week10_codebuild_test_project" {
  name          = var.codebuild_test_project_name
  description   = "t223306781sit722week10 codebuild test project"
  build_timeout = "5"
...
#################### CODEBUILD LINT #############################
resource "aws_codebuild_project" "t223306781sit722week10_codebuild_lint_project" {
  name          = var.codebuild_lint_project_name
  description   = "t223306781sit722week10 codebuild lint project"
  build_timeout = "5"
  service_role  = aws_iam_role.codebuild_role.arn
