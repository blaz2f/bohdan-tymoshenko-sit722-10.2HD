...
docker build -t $CONTAINER_REGISTRY/aws-storage:1 --file ../../aws-storage/Dockerfile-prod ../../aws-storage
docker push $CONTAINER_REGISTRY/aws-storage:1
...
envsubst < aws-storage.yaml | kubectl apply -f -
